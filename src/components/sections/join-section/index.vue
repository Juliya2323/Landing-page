<template>
  <div class="join">
    <ul class="join_sections">
      ...
      <li class="join_section center">
        <div class="join_img">
          <img :src="imgLink3" alt="img" />
        </div>
        <div class="join_info">
          <div class="join_title">Join our</div>
          <div class="join_subtitle">Community</div>
          <div class="join_description">
            Meet the Omise community,artists and collectors for platform
            update,announcements and more...
          </div>
          <base-button class="join_button">
            <svg
              class="join_button_discord"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <div class="join_button_text">Launch Discord</div>
          </base-button>
        </div>
        <div class="join_img">
